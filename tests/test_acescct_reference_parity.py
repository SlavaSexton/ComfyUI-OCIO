...
Run:  python tests/test_acescct_reference_parity.py     (no pytest, no ComfyUI, no GPU)

WHY THIS FILE EXISTS. tests/test_acescct.py checks that our curve round-trips to 1e-4 and that middle grey
...
def _load_io_nodes():
    ...
    established way of doing it in tests (see tests/test_write_output.py) - reused rather than reinvented."""
