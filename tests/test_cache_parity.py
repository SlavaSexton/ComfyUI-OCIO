...
(run: python tests/test_cache_parity.py). Needs opencolorio. No ComfyUI process required - the color nodes
...
print("=" * 70)
_lut_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "_test_cache_parity.cube")
