...
Run:  python tests/test_vae_decode_transforms.py     (no pytest, no ComfyUI, no GPU)
...
The existing tests/test_vae_decode.py could not see this, because its stand-in VAE only ever used the
