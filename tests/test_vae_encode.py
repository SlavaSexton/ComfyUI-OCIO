...
Run:  python tests/test_vae_encode.py        (no pytest, no ComfyUI, no GPU)
...
#
# The equivalent block lives in tests/test_vae_decode_transforms.py, and the duplication is deliberate:
