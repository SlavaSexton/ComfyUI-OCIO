"""Regression: the NCLC colour tags and metadata OCIO Write puts on a movie (run: python tests/test_video_color_tags.py).
...
def check_tag_whitelist(io):
    ...
    # embedded graph JSON, which is asserted against a real encode in tests/test_mov_metadata.py. MP4's ilst
