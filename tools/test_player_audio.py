"""Regression: OCIO Player carries a soundtrack, cut to the frames it cached (run: python tools/test_player_audio.py).
...
#
# Lifted out of web/ocio_io.js and run under node, for the same reason tools/test_view_narrowing.py does it:
